    ...
    data() {return {
        ...
        auto: {
            ...
            switch: {
                ...
                'withFooter @footer': {
                    'borderBind && ?nemstr(border) #class': [
                        'bd-{{borderPropVal.bd!=="" ? borderPropVal.bd : "m"}}',
                        'bd-po-t',
                        'bdc-{{borderPropVal.bdc!=="" ? borderPropVal.bdc : "m"}}',
                    ],
                    'true #props': {
