...
const defineSpfThemeColorItem = {
    ...
    computed: {
        ...
        colorShiftKey() {
            return this.colorValToKey.split('-')[1].toUpperCase();
        },
    },
    methods: {}
}
...
defineSpfThemeColorItem.template = `<div :class="styComputedClassStr.root" :style="styComputedStyleStr.root"><div class="item-title">{{colorShiftKey}}</div><div class="item-body"></div><div class="item-desc">{{colorValStr.toUpperCase()}}</div></div>`;
