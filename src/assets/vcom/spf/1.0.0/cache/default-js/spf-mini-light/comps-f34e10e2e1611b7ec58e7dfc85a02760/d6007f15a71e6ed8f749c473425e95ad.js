...
defineSpfLayout.template = `<div :class="styComputedClassStr.root" :style="styComputedStyleStr.root"><div class="layout-navbar-container"><spf-icon-logo :icon="logo" size="large"></spf-icon-logo><div class="layout-navbar"><slot name="navbar"></slot></div><div class="layout-usrbar"><spf-button icon="vant-sound" effect="popout" stretch="square" type="primary"></spf-button><spf-button icon="vant-setting" effect="popout" stretch="square" type="primary"></spf-button><spf-button icon="vant-logout" effect="popout" stretch="square" type="danger"></spf-button></div></div><div class="layout-mainbody"><div class="layout-menubar-container"><div class="menubar-navholder"></div><div class="layout-menubar"><slot name="menubar"></slot></div><div class="menubar-taskholder"></div></div><div class="layout-content"><slot></slot></div></div><div class="layout-taskbar-container"><div class="taskbar-ctrlbox"><spf-button icon="vant-eye-close" effect="popout" stretch="square" type="primary"></spf-button><spf-button icon="vant-close-square" effect="popout" stretch="square" type="danger"></spf-button></div><div class="layout-taskbar"><div class="taskbar-item"><spf-icon icon="vant-wechat-fill" size="small" type="success"></spf-icon><div class="taskitem-label">OMS 订货系统微信群</div><spf-button icon="vant-close" size="tiny" effect="popout" shape="circle" type="danger"></spf-button></div><div class="taskbar-item taskitem-active"><spf-icon icon="vant-alipay-circle-fill" size="small" type="primary"></spf-icon><div class="taskitem-label">支付宝付款后台查询</div><spf-button icon="vant-close" size="tiny" effect="popout" shape="circle" type="danger"></spf-button></div></div></div></div>`;
