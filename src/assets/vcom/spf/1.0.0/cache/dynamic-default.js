...
defineSpfIcon.template = `<svg :class="computedClass" :style="computedStyle" aria-hidden="true"><use v-if="icon!='-empty-'" v-bind:xlink:href="'#'+iconKey"><!--<animateTransform v-if="spin" attributeName="transform" attributeType="XML" type="rotate" :from="'0'+spinCenter" :to="'360'+spinCenter" dur="1.6s" repeatCount="indefinite" />--></use></svg>`;
