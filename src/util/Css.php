...
class Css extends Util 
{
     ...
     * css  <--->  array
     */
    public static function arr($css = "")
    {
    ...
    public static function css($arr = [])
    {
        if (!Is::nemarr($arr)) return "";
    }
    ...
    */
    ...
    //255 -> ff
    public static function color_dechex($num = 0)
    {
        $num = round($num);
        $s = dechex($num);
        if ($num<16) $s = "0".$s;
    ...
    //#ffffff -> [255, 255, 255]
    public static function color_rgb($colorHex = "#000000")
    {
        $ch = ltrim($colorHex, "#");
        return [    //[r,g,b]
    ...
    //[255, 255, 255] -> #ffffff
    public static function color_hex($rgb = [0,0,0])
    {
        $s = [];
        for ($i=0; $i<3; $i++) {
    ...
    public static function color_shift($colorHex = "#000000", $level = 10)
    {
    ...
    public static function color_brightness($hex = "#ffffff")
    {
        $rgb = color_rgb($hex);
     ...
     */
    public static function color_names($cn = null)
    {
        $cns = [
            "AliceBlue" => "#F0F8FF",
            "AntiqueWhite" => "#FAEBD7",
